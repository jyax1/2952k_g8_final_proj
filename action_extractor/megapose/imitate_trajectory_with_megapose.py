...
def imitate_trajectory_with_action_identifier(
    ...
    for root_z in roots:
        ...
        for demo in tqdm(demos, desc="Processing demos"):
            ...
            all_hand_poses_world, all_fingers_distances, all_hand_poses_world_from_side = action_identifier.get_all_hand_poses_finger_distances(front_frames_list, front_depth_list=None, side_frames_list=side_frames_list)
            actions_for_demo = action_identifier.compute_actions(all_hand_poses_world, all_fingers_distances, all_hand_poses_world_from_side, side_frames_list)
...
if __name__ == "__main__":
    ...
    imitate_trajectory_with_action_identifier(
        ...
        hand_mesh_dir="/home/yilong/Documents/action_extractor/action_extractor/megapose/panda_hand_mesh",
        output_dir="/home/yilong/Documents/action_extractor/debug/megapose_smallrot_RGB+bbox_square_2000",
        num_demos=100,
        save_webp=False,
        batch_size=40
    )
